...
public class CarePlanResourceProvider implements IResourceProvider {
    ...
    public List<CarePlan> getCarePlanForBulkData(List<Integer> patients, Date start) {
		...
		System.out.println();
		System.out.println("processCarePlanData - getCarePlanForBulkData - CAREPLAN DAFCAREPLAN FOR LOOP STARTS @ "+System.nanoTime());
		System.out.println();
		...
		System.out.println();
		System.out.println("processCarePlanData - getCarePlanForBulkData - CAREPLAN DAFCAREPLAN FOR LOOP ENDS @ "+System.nanoTime());
		System.out.println();
    ...
    private CarePlan createCarePlanObject(DafCarePlan dafCarePlan) 
    {
        ...
        //Set Status
        carePlan.setStatus(CarePlanStatusEnum.valueOf(dafCarePlan.getStatus().trim().toUpperCase()));
