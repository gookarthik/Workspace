...
public class DafMedication {
    ...
    private String med_code="111";

    @Column(name = "med_isbrand")
    @Type(type = "boolean")
    private boolean med_isBrand=true;

    @Column(name = "med_form")
    private String med_form="tablet";
    ...
    private String med_system="http://snomed.info/sct";
    
    Date d = new Date();
    
    @Column(name="last_updated")
    @Temporal(TemporalType.TIMESTAMP)
    private Date updated=d;
