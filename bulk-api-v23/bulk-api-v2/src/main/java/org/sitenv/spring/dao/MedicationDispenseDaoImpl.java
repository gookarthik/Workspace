...
public class MedicationDispenseDaoImpl extends AbstractDao implements MedicationDispenseDao {
    ...
    @Override
    public DafMedicationDispense saveMedicationDispense(DafMedicationDispense dafMedDis) {
    	System.err.println("MedicationDispense DAO IMPL");
    	 sessionFactory.openSession().saveOrUpdate(dafMedDis);
    	return dafMedDis;
    }
